          ...
          public function onCommand(CommandSender $sender, Command $cmd, $label, array $args){
                 switch($cmd->getName()) {
                         ...
                         case "tip":
                          ...
                          if(count($args) < 2){
                            ...
                            if($sender->hasPermission("braw.command.tip")){
                                 ...
                                 $this->getServer()->getScheduler()->scheduleRepeatingTask(new TipTask($this, $player, implode(" ", $args)), 5);
                         ...
                         case "popup":
                          ...
                          if(count($args) < 2){
                            ...
                            if($sender->hasPermission("braw.command.popup")){
								 ...
								 $colors = [C::BLACK, C::DARK_BLUE, C::DARK_GREEN, C::DARK_AQUA, C::DARK_RED, C::DARK_PURPLE, C::GOLD, C::GRAY, C::DARK_GRAY, C::BLUE, C::GREEN, C::AQUA, C::RED, C::LIGHT_PURPLE, C::YELLOW, C::WHITE];
								 $lastcolor = "§mc";
								 $this->getServer()->getScheduler()->scheduleRepeatingTask(new PopupTask($this, $player, implode(" ", $args)), 5);
                            ...
                            return true;
                             ...
                             if($sender->hasPermission("braw.command.popupworld")){
                               ...
                               foreach($this->getServer()->getLevelByName($args[0])->getPlayers() as $worldplayers){
								 ...
								 $this->getServer()->getScheduler()->scheduleRepeatingTask(new PopupTask($this, $worldplayers, implode(" ", $args)), 5);
						   ...
						   case "cban":
						       if(count($args) < 2) {
                                 ...
                                 if(!$player instanceof Player){
								   ...
								   $this->getServer()->getScheduler()->scheduleRepeatingTask(new BanTask($this, $player, implode(" ", $args)), 5);
								   ...
								   $this->getServer()->dispatchCommand(new ConsoleCommandSender(), $command);
								   $this->getServer()->getLogger()->info("§6" . $sender->getName() . " banned " . $playername . ". Reason: " . implode(" ",$args));
						   ...
						   case "cban-ip":
						       if(count($args) < 2) {
                                 ...
                                 if(!$player instanceof Player){
								   ...
								   $this->getServer()->getScheduler()->scheduleRepeatingTask(new BanTask($this, $player), 5);
						    ...
						    case "popupradius":
						       ...
						       if(count($args) < 2) {
                                 ...
                                 if(!is_numeric($radius)){
								   ...
								   foreach($sender->getLevel()->getPlayers() as $players){
                                      if($sender->distance($players) <= $radius){
										  $this->getServer()->getScheduler()->scheduleRepeatingTask(new PopupTask($this, $players, implode(" ", $args)), 5);
                                      }
                                   }
								   $this->getServer()->dispatchCommand(new ConsoleCommandSender(), $command);
								   $this->getServer()->getLogger()->info("§6" . $sender->getName() . " tellrawed all players in a radius of " . $radius . ". Message: " . implode(" ",$args));
							...
							case "tipradius":
						       ...
						       if(count($args) < 2) {
                                 ...
                                 if(!is_numeric($radius)){
								   ...
								   foreach($sender->getLevel()->getPlayers() as $players){
                                      if($sender->distance($players) <= $radius){
										  $this->getServer()->getScheduler()->scheduleRepeatingTask(new TipTask($this, $players, implode(" ", $args)), 5);
                                      }
                                   }
								   $this->getServer()->dispatchCommand(new ConsoleCommandSender(), $command);
								   $this->getServer()->getLogger()->info("§6" . $sender->getName() . " tellrawed all players in a radius of " . $radius . ". Message: " . implode(" ",$args));
                    ...
                    public function onEnable() {
						...
						$this->getServer()->getScheduler()->scheduleRepeatingTask(new SignTask($this), 10);
						$this->getServer()->getScheduler()->scheduleRepeatingTask(new ConfigReloadTask($this), 10);
					    $this->getServer()->getScheduler()->scheduleRepeatingTask(new FloatingTask($this), 10);
